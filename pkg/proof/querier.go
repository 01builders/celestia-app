...
func QueryTxInclusionProof(_ sdk.Context, path []string, req abci.QueryRequest) ([]byte, error) {
...
func QueryShareInclusionProof(_ sdk.Context, path []string, req abci.QueryRequest) ([]byte, error) {
