...
func NewMaxTotalBlobSizeDecorator(k BlobKeeper, consensusKeeper ConsensusKeeper) MaxTotalBlobSizeDecorator {
	return MaxTotalBlobSizeDecorator{k, consensusKeeper}
}
...
func (d MaxTotalBlobSizeDecorator) AnteHandle(ctx sdk.Context, tx sdk.Tx, simulate bool, next sdk.AnteHandler) (sdk.Context, error) {
	...
	max := d.maxTotalBlobSize(ctx, appVersion)
