...
func TestCheckLatestAttestationNonce(t *testing.T) {
	...
	assert.Equal(t, keeper.InitialLatestAttestationNonce, input.BlobstreamKeeper.GetLatestAttestationNonce(input.Context))
}
...
func TestCheckEarliestAvailableAttestationNonce(t *testing.T) {
	...
	input.BlobstreamKeeper.SetEarliestAvailableAttestationNonce(input.Context, keeper.InitialEarliestAvailableAttestationNonce)
	...
	assert.Equal(t, keeper.InitialEarliestAvailableAttestationNonce, input.BlobstreamKeeper.GetEarliestAvailableAttestationNonce(input.Context))
}
